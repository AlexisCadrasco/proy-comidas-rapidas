...
class ListaprecioP extends React.Component{
...
async fetchData(){
    const url = 'https://7ubmxobnpb.execute-api.us-east-2.amazonaws.com/Prueba/productos/listapreciopicadas';
...
<Card border="danger" style={{ width: '38rem' , marginLeft: '18rem'}} >
  ...
  <Form.Group controlId="listForm.ControlSelect1">
    ...
    <Form.Control as="select">
      ...
      <option  value="4">trifásica</option>      
    </Form.Control>
  </Form.Group>
