...
async fetchData(){
    const url = 'https://7ubmxobnpb.execute-api.us-east-2.amazonaws.com/Prueba/productos/listapreciosalchipapas';
...
<Card border="danger" style={{ width: '38rem' , marginLeft: '18rem'}} >
            ...
            <Card.Body>
              <Card.Title>Salchipapas</Card.Title>              
              <Card.Text>
              <ul>
    {est.map((task,index) =>  {
            return (
  ...
  <Form.Group controlId="listForm.ControlSelect1">
    ...
    <Form.Control as="select">
      ...
      <option  value="4">Salvajada</option>      
    </Form.Control>
  </Form.Group>
