...
class ListaprecioH extends React.Component{
...
async fetchData(){
    const url = 'https://7ubmxobnpb.execute-api.us-east-2.amazonaws.com/Prueba/productos/listapreciohamburguesas';
